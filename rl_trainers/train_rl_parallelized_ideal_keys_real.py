...
def main():
    ...
    for run_mode in run_modes[3:4]: # TODO: Run all modes
        for reward_mode in reward_modes[2:3]: # TODO: Run all modes
            ...
            model_path = f"saved_models/multi_actionl/real_gates/ppo_manning_agent_{reward_mode}_{run_mode}"
