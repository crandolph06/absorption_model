...
def main():
    ...
    for run_mode in run_modes[0:1]: # TODO: Run all modes
        for reward_mode in reward_modes[0:1]: # TODO: Run all modes
            ...
            model_path = f"saved_models/multi_action/book_gates/ppo_manning_agent_{reward_mode}_{run_mode}"
